...
public class NoticeXuegongPanel extends JPanel implements ActionListener,MouseMotionListener{
	...
	public void init(){
	   ...
	   // adjustTableColumnWidths(jt);
	    ...
	    jt.getColumnModel().getColumn(3).setCellEditor(new MyButtonEditor());//为了添加事件
	    jt.getColumnModel().getColumn(4).setCellEditor(new MyButtonEditor());//为了添加事件
	    jt.addMouseMotionListener(this);//鼠标悬停操作
